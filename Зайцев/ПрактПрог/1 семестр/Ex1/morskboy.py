...
while True:
    ...
    player.random()
    print_boards()
    print("Если вас не устраивает расположение ваших кораблей, то нажмите ENTER для новой генерации поля")
...
while game:
    ...
    while guessing:
        ...
        print("^ - буфер, . - пусто, А - корабль, х - попал, W - уничтожен, * - мимо")
