...
нач_главные_точки = copy(главная_точка)
...
print(нач_главные_точки)
print(главные_точки)
print(границы_кластеров)
for i in range(len(данные)):  # для всех элементов множества
    ...
    print(данные[i],  + 1 < len(данные) and данные[i] < главные_точки[текущий_кластер] < данные[i + 1])
    if not данные[i] < границы_кластеров[текущий_кластер]:  # если не пересекли границу текущего кластера
        plt.plot(x, y, 'ks')
        текущий_кластер += 1  # увеличиваем номер текущего кластера
        ...
        plt.plot(x, y, 'ks')
    elif i + 1 < len(данные) and данные[i] < главные_точки[текущий_кластер] < данные[i + 1]:
        plt.plot(x, y, 'ko')
    elif i == 0 or i + 1 == len(данные):
        plt.plot(x, y, 'ks')
    else:
        plt.plot(x, y, цвет)
